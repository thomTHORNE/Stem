...
**Why:** User caught Claude writing an import section directly after "sure" without showing a draft first, bypassing the review step. Established on [[northstar]] and carried across deliberately when Stem adopted the same working conventions.
